    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                ...
                <div class="email">mmjjonah@gmail.com</div>
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li role="separator" class="divider"></li>
                        <li><a href="<?=site_url('public/auth')?>"><i class="material-icons">input</i>Deconnexion</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2019 - 2020 <a href="javascript:void(0);">MultiADMIN - InDev</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0.0
            </div>
